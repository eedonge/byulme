...
class UploadHandler
{
    ...
    protected function get_user_id_param() {
        $name = $this->options['param_user_id'];
        return isset($_GET[$name]) ? basename(stripslashes($_GET[$name])) : null;
    }
    ...
    protected function set_user_upload_path($p_user_id, $p_file_type=null){
        ...
        $user_info = $this->bmMySql->bm_select_user_info($p_user_id);
    ...
    protected function set_file_info_and_upload($file_type=null, $user_id=null, $files=array()){
        $this->bmMySql->bm_connect();
        ...
        foreach($files as $key=>$value){            
            ...
            if($file_type=="MOVIE"){ 
                ...
                $file_thumb_name = $this->options['upload_basic_dir']."/".$this->options['user_path']."/".$value->name;
    ...
    public function post($print_response = true) {
        ...
        //User Id 설정한다.    
        $user_id = isset($_REQUEST[$this->options['param_user_id']]) ?
        $_REQUEST[$this->options['param_user_id']] : null;

        //File Type 설정한다.
        $file_type = isset($_REQUEST[$this->options['param_type']]) ?
